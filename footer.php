...
<div class="eco--footer eco--pd--100">
    <div class="container">
        <div class="row">            
			...
			<li><a href="http://37.220.38.191/"> YISP Reroute    </a></li>
			<li><a href="#"> nforce Reroute (Coming soon)   </a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script>
$('.pricing-term span.button-one').addClass('active');
jQuery('.pricing-term span').click(function(){
  $('.pricing-term span').removeClass('active');
  ...
  if(term==1){
    ...
    $('.pricing-term span.button-three').addClass('active'); 
  }else if(term==6){
    jQuery('#go-pricing-table-1194 .term').hide();
  	jQuery('#go-pricing-table-1194 .term.six').show();
    $('.pricing-term span.button-six').addClass('active'); 
  }else{
    jQuery('#go-pricing-table-1194 .term').hide();
  	jQuery('#go-pricing-table-1194 .term.twelve').show();
    $('.pricing-term span.button-twelve').addClass('active'); 
  }
});
</script>
